"""
Create properly formatted notebook
"""
import json

def create_code_cell(source_lines):
    """Create a code cell with proper line breaks"""
    return {
        "cell_type": "code",
        "metadata": {},
        "source": source_lines,
...
def create_markdown_cell(source_lines):
    """Create a markdown cell with proper line breaks"""
    return {
        "cell_type": "markdown",
        "metadata": {},
        "source": source_lines
...
cells.append(create_markdown_cell([
    ...
    "\n",
    "**ניתוח מקיף עם פיצ'רים משופרים + Train/Test Validation**\n",
    "\n",
    ...
    "- 🎯 **Best Results** — AUC של **0.9929** (שיפור של 34%!)\n",
    "\n",
    "---\n",
    "\n",
    "## Temporal Design\n",
    ...
    "## תוצאות עיקריות\n",
    "\n",
    "**Baseline:** LR=0.7404, RF=0.7225 ⚠️ Overfit  \n",
...
# Data Loading
cells.append(create_markdown_cell(["## 1. Data Loading"]))
...
# Pairs
cells.append(create_markdown_cell(["## 2. Train/Test Pairs"]))
...
# Features
cells.append(create_markdown_cell(["## 3. Feature Engineering\n", "\n", "### 3.1 Baseline (24 features)"]))
...
cells.append(create_markdown_cell(["### 3.2 Enhanced Features"]))
...
# Training
cells.append(create_markdown_cell(["## 4. Model Training & Evaluation"]))
...
cells.append(create_code_cell([
    ...
    "    results.append({\n",
    "        'Experiment': name,\n",
    "        'LR_Train': train_auc_lr,\n",
    "        'LR_Test': test_auc_lr,\n",
    "        'RF_Train': train_auc_rf,\n",
    "        'RF_Test': test_auc_rf,\n",
...
# Analysis
cells.append(create_markdown_cell(["## 5. Analysis & Conclusions"]))
...
cells.append(create_code_cell([
    ...
    "print(f'\\n🚀 KEY INSIGHT: Temporal features are GAME CHANGERS!')\n",
...
cells.append(create_markdown_cell([
    ...
    "2. ✅ 24 baseline features — All original features\n",
    ...
    "| ALL Combined LR | **0.9929** | 🏆 **WINNER!** |\n",
    "\n",
    "**Improvement: +0.2525 AUC (34% relative!)**\n",
    "\n",
    "### 🎯 Key Takeaways\n",
    "\n",
    "1. **Temporal features >> Topological** — Career history matters!\n",
    "2. **Simple + good features > Complex + basic** — LR beats RF\n",
    "3. **Always check train/test gap** — RF had overfitting\n",
    "\n",
    "---\n",
    "**🎓 Notebook complete! Ready for report.**"
]))
